...
def main():
    ...
    des_path=r'C:\Users\PC\Desktop\glamlora自拍款ai处理(整理好)\model7'
    skulist=os.listdir(Ori_path)
    src1 = r'C:\Users\PC\Desktop\20231027all_task\glamlora自拍款ai处理(整理好)\he16088he0009\he16088he0009-1.jpg'
