...
def main():
    ...
    des_path=r'C:\Users\PC\Desktop\glamlora自拍款ai处理(整理好)\model9'
    skulist=os.listdir(Ori_path)
    src1 = r'C:\Users\PC\Desktop\20231027all_task\glamlora自拍款ai处理(整理好)\he16088he0049\he16088he0049-4.jpg'
